...
public class TelaInicio extends JFrame{
    ...
    private boolean exclusaoValida;
      ...
      public TelaInicio()  {
          ...
          //Concateno o label om o atributo global nome da classe Usuario
          JLabel IblUsuario = new JLabel("Bem vindo " + Usuario.nomeUsuario);
          IblUsuario.setBounds(24, 65, 200, 15);
          tela.add(IblUsuario);
            ...
            btnVoltar.addActionListener((ActionEvent e) -> {
                try{
                  ...
                  dispose();
                   ...
                   System.out.println("Erro ao acessar a tela login "
                           + ec.getMessage());
                }
            });
